...
\begin{document}
	...
	\begin{frame}{Slider}
		\centering\begin{tikzpicture}
			...
			\node[right=of Component] (image) {\includegraphics[height=3cm]{../Images/Slider.png}};
	...
	\begin{frame}{Toggle Switch}
		\centering\begin{tikzpicture}
			...
			\node[right=of Component] (image) {\includegraphics[height=3cm]{../Images/Switch.png}};
	...
	\begin{frame}{Radio Button}
		\centering\begin{tikzpicture}
			...
			\node[right=of Component] (image) {\includegraphics[height=3cm]{../Images/RadioButton.png}};
